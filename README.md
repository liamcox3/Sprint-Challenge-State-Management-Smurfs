...
-   [ ] What problem does the context API help solve?
    ...
    It helps us not have to worry about prop drilling. It lets us share data across all levels of the app without having to pass the data down as props

-   [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

An action is a function that that is going to manipulate state in some way. Store is just an object that holds all of the apps states. Reducers house all the actions that come in and actually send the signla to manipulate state. An action comes into the reducer and the reducer fires off the function to change the state of the ui.

-   [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

Application state is like global state. Its good to use if you have lots of data that need to go to different levels of your application. component state is data that lives at the component level. Its good to use if you have data that is just staying at one level of your application.

-   [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

    redux-thunk is a library that allows use to write asyncronous code. Its middleware that takes in the actions and can send it to an api, stop it or let it pass on. It's like if the reducers were a country redux-thunk would be border patrol.

-   [ ] What is your favorite state management system you've learned and this sprint? Please explain why!
        So far useContext because its simplier to build out with small applications. I understand why we learn redux and see its uses in larger scale apps.
